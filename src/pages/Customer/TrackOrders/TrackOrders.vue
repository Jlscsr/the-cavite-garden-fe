<template>
  <div class="container mt-3">
    ...
    <div v-if="route.params.transactionId" class="d-flex justify-content-end">
      <button
      ...
      >
        ...
        <div class="d-flex flex-column mt-4">
          ...
          <div class="d-flex align-items-center justify-content-between mt-3">
            ...
            <div class="container d-flex flex-column gap-1">
              <h5 class="fs-6 m-0 fs-semi-bold text-secondary">Total Price:</h5>
              <p classs="mb-0 mt-2">{{ order?.totalPrice }}</p>
            </div>
            <div class="container d-flex flex-column gap-1">
              <h5 class="fs-6 m-0 fs-semi-bold text-secondary">Status:</h5>
              <p
                classs="mb-0 mt-2"
                :class="{
...
const getTransactionsByID = async () => {
  try {
    const response = await getTransactionsByCustomerID(route.params.customerId);
