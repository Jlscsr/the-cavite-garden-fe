      ...
      <div class="d-flex flex-column row-gap-3">
        <div class="d-flex gap-5">
          <div class="d-flex flex-column gap-3">
            <div class="">
              <p class="text-secondary fs-medium mb-0">First Name</p>
          ...
          <div class="d-flex flex-column gap-3">
            <div class="">
              <p class="text-secondary fs-medium mb-0">Last Name</p>
              <p v-if="!personalInfoEditMode" class="mb-0">
            ...
            <div class="">
              <p class="text-secondary fs-medium mb-0">Phone Number</p>
              <p v-if="!personalInfoEditMode" class="mb-0">
    ...
    <div class="border rounded p-4 mt-3">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li v-for="label in addressLabels" :key="label">
                <button class="btn dropdown-item" @click="selectAddress(label)">
                  {{ label }}
                </button>
              </li>
            </ul>
      ...
      <div class="d-flex gap-5">
        <div class="d-flex flex-column gap-3">
          ...
          <div class="">
            <p class="text-secondary fs-medium mb-0">Blk/Lot/Subdivision</p>
            <p class="mb-0">
        ...
        <div class="d-flex flex-column gap-3">
          <div class="">
            <p class="text-secondary fs-medium mb-0">Municipality</p>
      ...
      <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5 fs-medium" id="addressFormModalLabel">
